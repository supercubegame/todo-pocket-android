...
public final class MainActivity extends Activity {
    ...
    @Override protected void onActivityResult(int request,int result,Intent data){super.onActivityResult(request,result,data);if(screen!=null)screen.fileResult(request,result,data);}
